...
![static-server-result](https://chenshenhai.github.io/koa2-note/note/images/static-server-result-01.png)

##### 访问http://localhost:3000/index.html

![static-server-result](https://chenshenhai.github.io/koa2-note/note/images/static-server-result-02.png)

##### 访问http://localhost:3000/js/index.js

![static-server-result](https://chenshenhai.github.io/koa2-note/note/images/static-server-result-03.png)