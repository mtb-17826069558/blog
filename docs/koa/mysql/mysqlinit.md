...
![mysql-init-result-01](https://chenshenhai.github.io/koa2-note/note/images/mysql-init-result-01.png)

### 查看数据库写入数据

![mysql-init-result-01](https://chenshenhai.github.io/koa2-note/note/images/mysql-init-result-02.png)